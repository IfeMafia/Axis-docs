---
title: "Register your business on Axis"
sidebarTitle: "Onboarding"
description: "After signing up, register your business entity to unlock wallet creation and full API access. Takes a single POST request."
---
...
The `businessId` returned in the response is required when creating wallets. Store it in your application state as soon as you receive it — you will pass it to every wallet creation request.
